...
// Активный урок = реплики учеников + анализ Ко-Пилота на каждую фразу учителя + idle-события.
// Один педагог легко даёт 60-100 запросов/мин, поэтому лимит высокий — он лишь отсекает
// ботовый залёт на публичной ссылке, а не живого пользователя.
const MAX_HITS = 150;       // не больше 150 запросов с одного IP в минуту
